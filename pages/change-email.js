    ...
    return (
      <>
        <div className="menu-two">
          ...
          <div class="page-name">
            <span class="mycart">Change Email</span>
          </div>
                      ...
                      <div class="p-4 rounded">
                        <div class="form-body">
                          ...
                          >
                            ...
                            <p className="m-none">
                              Use the form below to change the e-mail address
                              for your Yamunaa account. Use the new address next
                              time you log in or place an order.
                            </p>
                          </div>
